...
# Test transA=True, transB=True case
M, N, K = 128, 128, 256
transa, transb = True, True

print("=" * 60)
print(f"Testing transA={transa}, transB={transb}")
print("This is the most common case for transformers")
print("=" * 60)
...
# For transA=True, transB=True: C = A^T @ B^T
