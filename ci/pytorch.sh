...
run_test_config(){
    ...
    NVTE_GEMM_BACKEND=TRITON run_default_fa_lbl "triton" 1 gemm/test_gemm.py
    ...
    NVTE_GEMM_BACKEND=FLYDSL NVTE_ROCM_ENABLE_MXFP8=1 run_default_fa_lbl "flydsl" 1 gemm/test_gemm.py
