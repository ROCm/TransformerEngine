...
The gh-pages checkout must already exist and be on the 'gh-pages' branch, e.g.:
  git clone -b gh-pages git@github.com:matthiasdiener/te-perf-dashboard-demo.git /tmp/te-dash
EOF
}

SRC="$(cd "$(dirname "${BASH_SOURCE[0]}")/dashboard" && pwd)"
