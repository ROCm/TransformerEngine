...
class FusedAttnRunner:
    ...
    def test_backward_small_seq_api(self):
        ...
        jitted_primitive = jit(
            value_and_grad(
                lambda q, k, v, bias, sequence_descriptor, dropout_rng: grad_func(
        ...
        jitted_reference = jit(
            value_and_grad(
                lambda q, k, v, bias, softmax_offset, mask, dropout_rng: grad_func(
                    jax_dpa,
                    q,
                    k,
                    v,
        ...
        reference_out, reference_dgrad = jitted_reference(
            self.q,
            self.k,
            self.v,
            self.bias,
