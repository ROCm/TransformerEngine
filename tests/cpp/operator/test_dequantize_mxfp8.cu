                             ...
                             const bool colwise)
{
    ...
    const size_t blocks_Y_rowwise = round_up_to_nearest_multiple(
        unpadded_blocks_Y_rowwise, mxfp8_scale_alignment(scale_tensor_alignment_Y_rowwise));
    const size_t blocks_X_rowwise = round_up_to_nearest_multiple(
        unpadded_blocks_X_rowwise, mxfp8_scale_alignment(scale_tensor_alignment_X_rowwise));
    const size_t blocks_Y_colwise = round_up_to_nearest_multiple(
        unpadded_blocks_Y_colwise, mxfp8_scale_alignment(scale_tensor_alignment_Y_colwise));
    const size_t blocks_X_colwise = round_up_to_nearest_multiple(
        unpadded_blocks_X_colwise, mxfp8_scale_alignment(scale_tensor_alignment_X_colwise));
