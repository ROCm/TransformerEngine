...
# MXFP4 GEMM dispatch lives fork-side (te_rocm.mxfp4_gemm, plugin plan S5.4); re-imported so
# in-file callers and any external importers are unchanged.
from transformer_engine.te_rocm.mxfp4_gemm import (  # noqa: E402
    get_tensor_device,
    _select_kernel_fp4,
    _fp4_gemm_core,
