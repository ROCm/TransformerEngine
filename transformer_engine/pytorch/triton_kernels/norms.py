...
def _te_norm_fwd_triton(
    ...
    if kernel == 'layer':
        ...
        kwargs["INPUT_ALIGNED_16"]=(input_tensor.data_ptr() % 16 == 0) and (input_tensor.stride(-1) % 16 == 0)
        kwargs["OUTPUT_ALIGNED_16"]=(out_ptr.data_ptr() % 16 == 0) and (out_ptr.stride(-1) % 16 == 0)
