...
REGISTER_NORM_LAUNCHER(RMSNorm, Backward, tuned, 128, fp32, fp32, fp32, fp32, 1, 4, 1, 16, 4);
REGISTER_NORM_LAUNCHER(RMSNorm, Backward, tuned, 128, fp16, fp16, fp16, fp32, 1, 4, 1, 8, 4);
REGISTER_NORM_LAUNCHER(RMSNorm, Backward, tuned, 128, fp16, fp32, fp16, fp32, 1, 4, 1, 8, 4);
REGISTER_NORM_LAUNCHER(RMSNorm, Backward, tuned, 128, bf16, bf16, bf16, fp32, 1, 4, 1, 8, 4);
REGISTER_NORM_LAUNCHER(RMSNorm, Backward, tuned, 128, bf16, fp32, bf16, fp32, 1, 4, 1, 8, 4);
