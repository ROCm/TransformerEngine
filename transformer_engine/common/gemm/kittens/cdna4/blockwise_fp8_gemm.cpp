...
void micro_tk_1d1d(micro_globals<kittens::fp8e4m3, kittens::fp8e4m3, OType> g) {
    ...
    for (int k = 0; k < k_iters - 2; k++, tic ^= 1, toc ^= 1) {
        ...
        const ColScale<RT_C::width> cs0 = load_col_scale<RT_C>(sb_col, local_n0, N);
        const ColScale<RT_C::width> cs1 = load_col_scale<RT_C>(sb_col, local_n1, N);
        ...
        __builtin_amdgcn_s_setprio(1);
        kittens::zero(p); mma_ABt_scaled<CBSZ, BLGP>(p, a, b0, p, &unit, &unit);
        scale_accumulate_1d1d(cA, p, rs0, cs0);
        __builtin_amdgcn_s_setprio(0);
        __builtin_amdgcn_s_barrier();
        __builtin_amdgcn_sched_barrier(0);
        ...
        __builtin_amdgcn_s_setprio(1);
        kittens::zero(p); mma_ABt_scaled<CBSZ, BLGP>(p, a, b1, p, &unit, &unit);
        scale_accumulate_1d1d(cB, p, rs0, cs1);
        __builtin_amdgcn_s_setprio(0);
        __builtin_amdgcn_s_barrier();
        ...
        __builtin_amdgcn_s_setprio(1);
        kittens::zero(p); mma_ABt_scaled<CBSZ, BLGP>(p, a, b0, p, &unit, &unit);
        scale_accumulate_1d1d(cC, p, rs1, cs0);
        __builtin_amdgcn_s_setprio(0);
        __builtin_amdgcn_s_barrier();
        __builtin_amdgcn_sched_barrier(0);
        ...
        __builtin_amdgcn_s_setprio(1);
        kittens::zero(p); mma_ABt_scaled<CBSZ, BLGP>(p, a, b1, p, &unit, &unit);
        scale_accumulate_1d1d(cD, p, rs1, cs1);
        __builtin_amdgcn_s_setprio(0);
        __builtin_amdgcn_s_barrier();
    }
