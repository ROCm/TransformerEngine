...
/*! \brief Fused MXFP4 cast + transpose with optional scale/data shuffling.
 *
 *  ROCm-only kernel for gfx950. Converts BF16 input to MXFP4 format with
 *  optional Hadamard transform and memory-layout shuffling for GEMM.
 */
