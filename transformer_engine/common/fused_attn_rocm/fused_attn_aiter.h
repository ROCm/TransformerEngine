...
/*! \file fused_attn_aiter.h
 *  \brief Enums and functions for fused attention aiter backend.
 */

 #ifndef TRANSFORMER_ENGINE_FUSED_ATTN_ROCM_FUSED_ATTN_AITER_H_
 #define TRANSFORMER_ENGINE_FUSED_ATTN_ROCM_FUSED_ATTN_AITER_H_
 #include "transformer_engine/fused_attn.h"
 
 namespace transformer_engine {
 namespace fused_attn_rocm {
 // check the fused attn config to see whether it's aiter backend supported
 bool is_aiter_backend_supported(
   NVTEDType q_dtype,
   NVTEDType kv_dtype,
 ...
 void fused_attn_aiter_fwd_qkvpacked(
 ...
 void fused_attn_aiter_bwd_qkvpacked(
   size_t b, size_t h, size_t max_seqlen, size_t d_qk, size_t d_v,
 ...
 void fused_attn_aiter_fwd_kvpacked(
 ...
 void fused_attn_aiter_bwd_kvpacked(
   size_t b, size_t h_q, size_t h_kv, size_t max_seqlen_q, size_t max_seqlen_kv, size_t d_qk, size_t d_v,
   float attn_scale, float dropout, 
   NVTE_QKV_Layout qkv_layout, NVTE_Bias_Type bias_type, NVTE_Mask_Type attn_mask_type,
   int64_t window_size_left, int64_t window_size_right,
 ...
 #endif //#ifndef TRANSFORMER_ENGINE_FUSED_ATTN_ROCM_FUSED_ATTN_AITER_H_
