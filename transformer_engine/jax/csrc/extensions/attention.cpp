...
pybind11::tuple GetFusedAttnForwardWorkspaceSizes(
  ...
  auto v_shape = std::vector<size_t>{input_batch * kv_max_seqlen, num_gqa_groups, head_dim};
...
static void FusedAttnForwardImpl(
    ...
    size_t head_dim, size_t max_segments_per_seq, size_t wkspace_size,
    float scaling_factor, float dropout_probability, NVTE_Bias_Type bias_type,
...
Error_Type FusedAttnForwardFFI(cudaStream_t stream, Buffer_Type q_buf, Buffer_Type k_buf,
  ...
  FusedAttnForwardImpl(
      ...
      head_dim, max_segments_per_seq, wkspace_size, scaling_factor,
