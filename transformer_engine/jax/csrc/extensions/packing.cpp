...
pybind11::bytes PackCustomCallFusedAttnDescriptor(
  ...
  return PackOpaque(
      CustomCallFusedAttnDescriptor{input_batch,          bias_batch,    q_max_seqlen,
                                    ...
                                    bias_heads,           qk_head_dim,   v_head_dim,
                                    max_segments_per_seq, wkspace_size,  scaling_factor,
                                    dropout_probability,  bias_type,     mask_type,
                                    qkv_layout,           dtype,         wkspace_dtype,
                                    is_training,          deterministic, window_size_left,
                                    window_size_right});
}
