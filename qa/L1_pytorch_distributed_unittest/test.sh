...
python3 -m pytest -v -s --junitxml=$XML_LOG_DIR/pytest_test_torch_fsdp2_fp8.xml $TE_PATH/tests/pytorch/distributed/test_torch_fsdp2_fp8.py || test_fail "test_torch_fsdp2_fp8.py"
