...
NVTE_ALLOW_NONDETERMINISTIC_ALGO=0 python3 -m pytest --tb=auto --junitxml=$XML_LOG_DIR/pytest_test_attention_deterministic.xml $TE_PATH/tests/pytorch/attention/test_attention.py -k "test_deterministic_bwd_ck" || test_fail "NVTE_ALLOW_NONDETERMINISTIC_ALGO=0 test_attention.py"
